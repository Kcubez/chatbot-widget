...
const COURSE_DETAILS: Record<string, string> = {
  ...
  hsk_premium: `📚 HSK Premium Class\n\nHSK (Hanyu Shuiping Kaoshi) နိုင်ငံတကာအသိအမှတ်ပြု တရုတ်ဘာသာစကားအရည်အချင်းစစ်စာမေးပွဲအတွက် Premium အတန်းဖြစ်ပါတယ်ရှင့်။\n\nတရုတ်နိုင်ငံမှ ထုတ်ဝေထားသော 《标准教程》 (Standard Course) သင်ရိုးစာအုပ်ဖြင့် HSK စာမေးပွဲအတွက် စနစ်တကျ အထူးပြု ပြင်ဆင်သင်ကြားပေးပါတယ်။\n\n• နေ့စဉ်ဘဝတွင် အသုံးများသော တရုတ်စကားလုံးများ\n• ဝါကျများနှင့် Grammar Patterns\n• တရုတ်ယဉ်ကျေးမှု အခြေခံဗဟုသုတ\n• HSK မေးခွန်းပုံစံများနှင့် မေးခွန်းဟောင်းများ\n• Premium လမ်းညွှန်မှုဖြင့် စနစ်တကျလေ့ကျင့်ပေးခြင်း\n\n💰 HSK Premium Class သင်တန်းကြေးနှင့် လက်ရှိအတန်းချိန်ကို Admin Team မှ စစ်ဆေးပြီး ပြန်လည်အကြောင်းကြားပေးပါမယ်ရှင့်။`,
};
...
const FAQ_DETAILS: Record<string, string> = {
  ...
  differences: '🎓 Golden Package Class သည် Reading, Writing, Listening နှင့် Speaking အားလုံးကို စနစ်တကျလေ့လာလိုသူများအတွက် Online Class ဖြစ်ပါတယ်။\n\n🤖 AI Golden Package Class သည် Golden သင်ရိုးကို အခြေခံပြီး Teacher + AI Technology ဖြင့် Speaking၊ အသံထွက်နှင့် Writing ကို ထပ်မံလေ့ကျင့်နိုင်ပါတယ်။\n\n🗣️ Speaking Class သည် Speaking ကို အဓိကထားလိုသူများနှင့် စနေ/တနင်္ဂနွေ၊ Sunday Only ကဲ့သို့ အားလပ်ချိန်အလိုက် ဖြည်းဖြည်းလေ့လာလိုသူများအတွက် သင့်တော်ပါတယ်။\n\n📚 HSK Class သည် 《标准教程》 (Standard Course) သင်ရိုးဖြင့် HSK စာမေးပွဲအတွက် ပြင်ဆင်ပေးတဲ့ အတန်းဖြစ်ပါတယ်။\n\n⭐ HSK Premium Class သည် HSK သင်ရိုးကိုပဲ Premium လမ်းညွှန်မှုဖြင့် အထူးပြုလေ့ကျင့်ပေးတဲ့ အတန်းဖြစ်ပါတယ်ရှင့်။\n\nGolden နှင့် AI Golden ကို Level ၈ ခုလုံးပြီးဆုံးပါက ဘွဲ့အခမ်းအနား Certificate ရရှိနိုင်ပြီး Speaking Level ၈ ခုလုံးပြီးဆုံးပါက PDF Certificate ရရှိနိုင်ပါတယ်။ Class များအားလုံး Level ၈ ခုလုံးပြီးဆုံးပါက Job Interview အခွင့်အရေးများ ရရှိနိုင်ပါတယ်ရှင့်။',
...
const FLOW_DEFAULTS: Record<string, string> = {
  ...
  class_ai_golden: 'AI Golden Package', class_golden: 'Golden Package Class', class_speaking: 'Speaking Class', class_hsk: 'HSK Class', class_hsk_premium: 'HSK Premium Class',
  schedule_button: 'အတန်းချိန်မေးရန်',
...
function courseScheduleButtons(bot: any, classId: string) {
  return [
    { title: flowText(bot, 'schedule_button').slice(0, 20), payload: `EDU_SCHEDULE_${classId}` },
