          ...
          <div className="space-y-3 rounded-2xl border border-zinc-800 bg-zinc-950/30 p-4">
            ...
            <div className="grid grid-cols-1 gap-3 sm:grid-cols-2">
              {([
                ...
                { id: 'education_registration', label: 'Education Registration Bot', desc: 'Button-only Messenger enrollment with admin approval.' },
          ...
          <div className="space-y-3">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              {([
                ...
                { id: 'education_registration', label: 'Education Registration Bot' },
              ...
              >
                ...
                <div className="col-span-2 flex flex-wrap justify-center gap-1">
                  {([
                    ...
                    { id: 'education_registration', label: 'EDU' },
